...
void draw()
{
  ...
  textFont(f, 24);                 
  fill(random(0, 50));                         
  int x=(int)random(myImage.width/2-thresholdX, myImage.width/2+thresholdX); //was250
  int y =(int)random(myImage.height*5/6-thresholdY, myImage.height*5/6+thresholdY);//was100
